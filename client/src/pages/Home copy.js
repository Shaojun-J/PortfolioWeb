...
export default function Home() {
    return (
        <div>
            <nav className="navbar bg-light fixed-top" style={{ width: "fit-content" }}>
                <div className="container">
                    <button className="navbar-toggler btn-dark d-md-none" type="button" data-bs-toggle="offcanvas"
                        data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
                        <span className="navbar-toggler-icon"></span>
                    </button>
                    <div className="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                        aria-labelledby="offcanvasNavbarLabel" style={{ max_width: '240px', background_color: '#f2f3f7' }}>
                        <div className="offcanvas-body text-center">
                            <div>
                                <div className="photo_wrapper">
                                    <img style={{ width: '145px', height: '150px', border_radius: '50%' }} src={"./image/my.jpg"} />
                                </div>
                            ...
                            <div>
                                <nav className="nav_style">
                                    <ul className="nav justify-content-center flex-column" >
                                        ...
                                        <li className="nav-item">
                                            <a href="./labworks.html">Lab Works</a>
                                        </li>

                                        <li className="nav-item">
                                            <a href="./websites.html">Interesting Site</a>
                                        </li>
            ...
            <div className="row ">
                <div className="col-md-3" style={{ position: 'fixed', max_width: '240px', min_width: '240px' }}>
                                    ...
                                    <div className="contact_table">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="https://www.linkedin.com/in/shaojun-jiang-318150222/"
                                                        target="_blank">linkedin.com/in/shaojun-jiang-318150222</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
